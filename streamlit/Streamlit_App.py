...
def complete():
    ...
    if len(df1) == 0:
        ...
        st.write(
            'Currently, the accuracy of this machine learning model is 50% (which is pathetic). However, the accuracy changes everytime the data is scraped. An updated model is under progress and will be posted when ready!')
